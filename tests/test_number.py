...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([10**36], "1.0 undecillion"),
        ([10**39], "1.0 duodecillion"),
        ([10**42], "1.0 tredecillion"),
        ([10**45], "1.0 quattuordecillion"),
        ([10**48], "1.0 quindecillion"),
        ([10**51], "1.0 hexdecillion"),
        ([10**54], "1.0 septendecillion"),
        ([10**57], "1.0 octodecillion"),
        ([10**60], "1.0 novemdecillion"),
        ([10**63], "1.0 vigintillion"),
        ([10**66], "1.0 unvigintillion"),
        ([10**69], "1.0 duovigintillion"),
        ([10**72], "1.0 trevigintillion"),
        ([10**75], "1.0 quattourvigintillion"),
        ([10**78], "1.0 quinvigintillion"),
        ([10**81], "1.0 hexvigintillion"),
        ([10**84], "1.0 septenvigintillion"),
        ([10**87], "1.0 octovigintillion"),
        ([10**90], "1.0 novemvigintillion"),
        ([10**93], "1.0 trigintillion"),
        ([10**96], "1.0 untrigintillion"),
